...
const router = createBrowserRouter([
    ...
    },
    {
        ...
        children: [
            ...
            { path: "myarticle", element: <MyArticles /> },
            { path: "mycommentarticle", element: <MyArticles /> },
            { path: "myscrap", element: <MyArticles /> },
        ],
    },
    {
        path: "/register",
    ...
    },
    {
        ...
        element: (
            <PublicRoute component={<StudentRegister />} restricted={true} />
        ),
        errorElement: <NotFound />,
    },
    {
        ...
        element: (
            <PublicRoute component={<TeacherRegister />} restricted={true} />
        ),
        errorElement: <NotFound />,
    },
]);
